...
public class GroundSlamParticle extends NoRenderParticle {
    ...
    protected GroundSlamParticle(ClientLevel level, double x, double y, double z, double dx, double dy, double dz) {
        ...
        // Safety: ensure this only runs on client
        ...
        for (int i = 0; i < (int) dy; i++) {
            ...
            // Smoke particle
            Particle smokeParticle = mc.particleEngine.createParticle(ParticleTypes.CAMPFIRE_COSY_SMOKE,
                    x + positionVec.x * 0.5D, y + 1.5D, z + positionVec.z * 0.5D, 0, 0, 0);
    ...
    public static class Provider implements ParticleProvider<SimpleParticleType> {
        ...
        public Particle createParticle(SimpleParticleType typeIn, ClientLevel level, double x, double y, double z, double xSpeed, double ySpeed, double zSpeed) {
            // Safety: only create particle on client
